        ...
        for job in JobShop_module.jobs:
            for operation in job.operations:
                for machine, pt in operation.processing_times.items():
                    ...
                    # print(op_pt_list[0, operation.operation_id])
        # print(job_length_list.shape)
        # print(job_length_list)
        # print(JobShop_module.nr_of_operations)

        # test = np.count_nonzero(op_pt_list, axis=2)
        # print(test)
        # print(test.shape)
        # exit()
